...
#define NATIVE_GUI_START                                                         \
    ...
    {                                                                            \
        if (args.size() > 0)                                                     \
        {                                                                        \
            throw std::runtime_error("This method does not take any arguments"); \
        }                                                                        \
        gui.start();                                                             \
        push(nullptr);                                                           \
        break;                                                                   \
...
#define NATIVE_GUI_DRAW_TEXT                                                                        \
    ...
    {                                                                                               \
        ...
        if (!std::holds_alternative<double>(args[1]) || !std::holds_alternative<double>(args[2]) || \
            ...
            throw std::runtime_error("Use the correct arguments, x, y and size must be numbers");   \
                                                                                                    \
...
#define NATIVE_GUI_DRAW_TEXT_COLOR                                                                             \
    ...
    {                                                                                                          \
        ...
        if (!std::holds_alternative<double>(args[1]) ||                                                        \
            ...
            !std::holds_alternative<double>(args[5]) ||                                                        \
            !std::holds_alternative<double>(args[6]))                                                          \
        {                                                                                                      \
            throw std::runtime_error("Use the correct arguments, x, y, r, g and b must be numbers");           \
        }                                                                                                      \
                                                                                                               \
        std::string text = std::get<std::string>(args[0]);                                                     \
        int x = (int)std::get<double>(args[1]);                                                                \
        ...
        {                                                                                                      \
            throw std::runtime_error("Use the correct arguments, the RGB colors must not go beyond 255");      \
        }                                                                                                      \
    ...
    {                                                                                                            \
        ...
        if (!std::holds_alternative<std::string>(args[0]))                                                       \
            throw std::runtime_error("Use the correct arguments, first argument must be string");                \
                                                                                                                 \
        if (!std::holds_alternative<double>(args[1]))                                                            \
            throw std::runtime_error("Use the correct arguments, second argument must be number");               \
                                                                                                                 \
...
#define NATIVE_GUI_UNLOAD_TEXTURE                                                                    \
    case NativeMethod::GUI_UNLOAD_TEXTURE:                                                           \
    {                                                                                                \
        if (args.size() != 1)                                                                        \
            throw std::runtime_error("Use the correct arguments, unload_texture(texture)");          \
                                                                                                     \
        if (!std::holds_alternative<std::shared_ptr<Texture2D>>(args[0]))                            \
            throw std::runtime_error("Use the correct arguments, first argument must be a texture"); \
                                                                                                     \
...
#define NATIVE_GUI_DRAW_RECT                                                                      \
    ...
    {                                                                                             \
        ...
        if (!std::holds_alternative<double>(args[0]) ||                                           \
            ...
            !std::holds_alternative<double>(args[3]))                                             \
        {                                                                                         \
            throw std::runtime_error("Use the correct arguments, x, y, w and h must be numbers"); \
        }                                                                                         \
                                                                                                  \
...
#define NATIVE_GUI_DRAW_RECT_ADV                                                                                                                                                                                                      \
    ...
    {                                                                                                                                                                                                                                 \
        ...
        if (!std::holds_alternative<double>(args[0]) ||                                                                                                                                                                               \
            !std::holds_alternative<double>(args[1]) ||                                                                                                                                                                               \
            !std::holds_alternative<double>(args[2]) ||                                                                                                                                                                               \
            !std::holds_alternative<double>(args[3]) || !std::holds_alternative<double>(args[4]) || !std::holds_alternative<double>(args[5]) || !std::holds_alternative<double>(args[6]) || !std::holds_alternative<double>(args[7])) \
        {                                                                                                                                                                                                                             \
            throw std::runtime_error("Use the correct arguments, x, y, w, h, r, g and b must be numbers");                                                                                                                            \
        }                                                                                                                                                                                                                             \
                                                                                                                                                                                                                                      \
        int x = (int)std::get<double>(args[0]);                                                                                                                                                                                       \
        int y = (int)std::get<double>(args[1]);                                                                                                                                                                                       \
...
#define NATIVE_GUI_DRAW_CIRCLE                                                                                                                \
    ...
    {                                                                                                                                         \
        ...
        {                                                                                                                                     \
            throw std::runtime_error("Use the correct arguments, x, y and r must be numbers");                                                \
        }                                                                                                                                     \
        int x = (int)std::get<double>(args[0]);                                                                                               \
        int y = (int)std::get<double>(args[1]);                                                                                               \
...
#define NATIVE_GUI_LOAD_TEXTURE                                                             \
    ...
    {                                                                                       \
        ...
        if (!gui.running)                                                                   \
        {                                                                                   \
            throw std::runtime_error("The graphical user interface system is not running"); \
        }                                                                                   \
...
#define NATIVE_GUI_DRAW_TEXTURE                                                                          \
    ...
    {                                                                                                    \
        ...
        if (!std::holds_alternative<std::shared_ptr<Texture2D>>(args[0]))                                \
        {                                                                                                \
            throw std::runtime_error("Use the correct arguments, the first argument must be a texture"); \
        }                                                                                                \
                                                                                                         \
        if (!std::holds_alternative<double>(args[1]) || !std::holds_alternative<double>(args[2]))        \
        {                                                                                                \
            throw std::runtime_error("Use the correct arguments, x and y must be numbers");              \
        }                                                                                                \
        auto tex = std::get<std::shared_ptr<Texture2D>>(args[0]);                                        \
        int x = (int)std::get<double>(args[1]);                                                          \
        int y = (int)std::get<double>(args[2]);                                                          \
    ...
    {                                                                                                                                                                                     \
        ...
        {                                                                                                                                                                                 \
            throw std::runtime_error("Use the correct arguments, the first argument must be a texture");                                                                                  \
                                                                                                                                                                                          ...
                                                                                                                                                                                          \
        if (!std::holds_alternative<double>(args[1]) || !std::holds_alternative<double>(args[2]) || !std::holds_alternative<double>(args[3]) || !std::holds_alternative<double>(args[4])) \
        {                                                                                                                                                                                 \
            throw std::runtime_error("Use the correct arguments, x, y, w and h must be numbers");                                                                                         \
        }                                                                                                                                                                                 \
                                                                                                                                                                                          \
    ...
    {                                                                                                                                                                                     \
        ...
        {                                                                                                                                                                                 \
            throw std::runtime_error("Use the correct arguments, x, y, w and h must be numbers");                                                                                         \
                                                                                                                                                                                          ...
                                                                                                                                                                                          \
        if (!std::holds_alternative<bool>(args[5]) || !std::holds_alternative<bool>(args[6]))                                                                                             \
        {                                                                                                                                                                                 \
            throw std::runtime_error("Use the correct arguments, flip_x and flip_y must be numbers");                                                                                     \
        }                                                                                                                                                                                 \
                                                                                                                                                                                          \
        auto tex = std::get<std::shared_ptr<Texture2D>>(args[0]);                                                                                                                         \
        int x = (int)std::get<double>(args[1]);                                                                                                                                           \
...
#define NATIVE_GUI_CREATE_TEXT                                                                                     \
    ...
    {                                                                                                              \
        ...
        if (!std::holds_alternative<double>(args[1]) ||                                                            \
            ...
            !std::holds_alternative<double>(args[5]) ||                                                            \
            !std::holds_alternative<double>(args[6]))                                                              \
            throw std::runtime_error("Use the correct arguments, x, y, size, r, g and b must be numbers");         \
                                                                                                                   \
        int r = (int)std::get<double>(args[4]);                                                                    \
        int g = (int)std::get<double>(args[5]);                                                                    \
        int b = (int)std::get<double>(args[6]);                                                                    \
    ...
    {                                                                                                             \
        if (args.size() != 1)                                                                                     \
            throw std::runtime_error("Use the correct arguments, draw_text_element(element)");                    \
                                                                                                                  \
        if (!std::holds_alternative<std::shared_ptr<TextElement>>(args[0]))                                       \
            throw std::runtime_error("Use the correct arguments, the first argument must be a text element");     \
                                                                                                                  \
...
#define NATIVE_GUI_SET_TEXT                                                                                   \
    ...
    {                                                                                                         \
        if (args.size() != 1)                                                                                 \
            throw std::runtime_error("Use the correct arguments, set_text_element(element)");                 \
                                                                                                              \
        if (!std::holds_alternative<std::shared_ptr<TextElement>>(args[0]))                                   \
            throw std::runtime_error("Use the correct arguments, the first argument must be a text element"); \
                                                                                                              \
...
#define NATIVE_GUI_RECTANGLE_COLLISION                                                                                            \
    ...
    {                                                                                                                             \
        ...
        {                                                                                                                         \
            throw std::runtime_error("Use the correct arguments, a and b must be arrays");                                        \
        }                                                                                                                         \
                                                                                                                                  \
...
#define NATIVE_GUI_RECTANGLE_MOUSE_COLLISION                                                             \
    ...
    {                                                                                                    \
        ...
        {                                                                                                \
            throw std::runtime_error("Use the correct arguments, the first argument must be an array");  \
        }                                                                                                \
                                                                                                         \
